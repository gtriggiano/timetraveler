...
!function (a, b) {
  ...
  function a() {
    ...
    var b = [];for (var c in a) b.push({ unit: c, priority: He[c] });return b.sort(function (a, b) {
    ...
    var b,
        c,
        d = a.match(Ie);for (b = 0, c = d.length; b < c; b++) Le[d[b]] ? d[b] = Le[d[b]] : d[b] = V(d[b]);return function (b) {
      var e,
    ...
    for (var b in a) if (Rf.indexOf(b) === -1 || null != a[b] && isNaN(a[b])) return !1;for (var c = !1, d = 0; d < Rf.length; ++d) if (a[Rf[d]]) {
